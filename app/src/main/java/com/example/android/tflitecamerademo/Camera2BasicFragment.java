...
public class Camera2BasicFragment extends Fragment
  ...
  public static Boolean thisflag=false;
  public String timerv=null;
...
private ProgressBar progressBar;
  ...
  public int chances=1,left;

  /** Max preview widt,h that is guaranteed by Camera2 API */
...
/*
    start.setOnClickListener(new View.OnClickListener() {
      @Override
      public void onClick(View v) {
        textView.setText(classifier.random());
      }
    });
    */
    try {
